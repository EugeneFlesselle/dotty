...
class Definitions {
  ...
  @tu lazy val Mirror_ProductProxyClass: ClassSymbol = requiredClass("scala.deriving.Mirror.ProductProxy")
    @tu lazy val Mirror_ProductProxy_fromProduct: Symbol = Mirror_ProductProxyClass.requiredMethod(nme.fromProduct)
    @tu lazy val Mirror_ProductProxy_defaultArgument: Symbol = Mirror_ProductProxyClass.requiredMethod(nme.defaultArgument)
